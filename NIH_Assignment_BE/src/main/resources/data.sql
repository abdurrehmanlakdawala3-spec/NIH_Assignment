...
-- Courses (20 records)
INSERT INTO course (id, course_code, title, description, created_at) VALUES
(1, 'CS-101', 'Introduction to Computer Science', 'Fundamentals of programming and computer science.', NOW()),
...
-- Students
INSERT INTO student (id, first_name, last_name, email, date_of_birth, created_at) VALUES
(1, 'John', 'Doe', 'john.doe@example.com', '2002-05-15', NOW()),
...
-- Enrollments
INSERT INTO enrollment (id, student_id, course_id, created_at) VALUES
(1, 1, 1, NOW()),   -- John Doe in CS-101
...
(20, 18, 19, NOW());-- Elizabeth Jackson in ECON-102
...
ALTER TABLE course ALTER COLUMN id RESTART WITH 21;
ALTER TABLE student ALTER COLUMN id RESTART WITH 21;
ALTER TABLE enrollment ALTER COLUMN id RESTART WITH 21;
